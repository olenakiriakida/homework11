...
int main()
{
    ...
    cout << "Amount of students in the group: " << a.GetStudentsAmount() << "\n";

    a.ShowStudents();

    Group p;
    p.SetName("Cube Entities");
    p.SetSpecialization("Workers");
    p.SetCourseNumber(33033);
    ...
    cout << "Amount of students in the group: " << p.GetStudentsAmount() << "\n";
